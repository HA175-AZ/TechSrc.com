...
<section class="products shopping-cart">
   ...
   <h3 class="heading">Panier d'achats</h3>
   ...
   <form action="" method="post" class="box">
      ...
      <input type="submit" value="Supprimer l'article" onclick="return confirm('Supprimer cet article du panier ?');" class="delete-btn" name="delete">
   </form>
   <?php
   ...
   <div class="cart-total">
      ...
      <a href="cart.php?delete_all" class="delete-btn <?= ($grand_total > 1)?'':'disabled'; ?>" onclick="return confirm('Supprimer tous les articles du panier ?');">Supprimer tout</a>
